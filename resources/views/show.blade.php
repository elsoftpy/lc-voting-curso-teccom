        ...
        <div class="flex flex-1 px-4 py-6">
            ...
            <div class="w-full mx-4">
                <h4 class="text-xl font-semibold">
                    <a href="#" class="hover:underline">Un título cualquiera</a>
                </h4>
                ...
                <div class="flex items-center justify-between mt-6">
                    <div class="flex items-center text-xs text-gray-400 font-semibold space-x-2">
                        <div class="font-bold text-gray-900">John Von Achon</div>
                        <div>&bull;</div>
                    ...
                    <div x-data="{ isOpen: false }"
                        ...
                        <div class="bg-gray-200 text-xxs font-bold uppercase leading-none rounded-full text-center w-28 h-7 py-2 px-4">Abierta</div>
    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        <div class="flex items-center space-x-5 ml-6">
            ...
            <div x-data="{isOpen: false}"
                ...
                <button @click="isOpen = !isOpen"
                    type="button"
                    class="flex items-center justify-center w-42 h-11 text-sm bg-gray-200 font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3"
                >
                        ...
                        <div x-data="{isOpen: false}"
                            ...
                            <button @click="isOpen = !isOpen"
                                ...
                                <ul x-cloak
                                    ...
                                    @click.away="isOpen = false"
                                    @keydown.escape.window="isOpen = false"
                                    class="z-20 absolute w-44 text-left font-semibold bg-white shadow-dialog rounded-xl py-3 ml-8">
                                    <li><a href="#" class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">Es Spam</a></li>
